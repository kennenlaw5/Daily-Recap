function snapshot31(x,y) {
  ...
  var newCount=[0,0,0,0,0,0,0];var newF_I=[0,0,0,0,0,0,0];
  var cpoCount=[0,0,0,0,0,0];var cpoF_I=[0,0,0,0,0,0];
  var usedCount=[0,0,0,0,0,0];var usedF_I=[0,0,0,0,0,0];
    ...
    if(sheet!=null){
      ...
      for(var j=0;j<sheet.getLastRow()-2;j++){
        if(range[j][0]!=""&&range[j][19]!=""){
          team=range[j][19];
          if(range[j][22].toLowerCase()=="yes"){newCount[6]++;}
          else if(range[j][22].toLowerCase()=="no"){newF_I[6]++;}
          if(team=="Jeff Englert"){team=0;}
          else if(team=="Ben Brahler"){team=1;}
          else if(team=="Robb Ashby"){team=2;}
          else if(team=="Anna Wright"){team=3;}
          else if(team=="Seth Carmitchel"){team=4;}
          else if(team=="Dean Wentland"||team=="Mark Sanders"){team=5;}
          else{team=6;}
          if(range[j][0]=="N"&&team!=6){newCount[team]+=1;if(!isNaN(parseInt(range[j][12]))){newF_I[team]+=parseInt(range[j][12]);}}
          else if(range[j][0]=="U"&&team!=6){usedCount[team]+=1;if(!isNaN(parseInt(range[j][12]))){usedF_I[team]+=parseInt(range[j][12]);}}
          else if(range[j][0]=="C"&&team!=6){cpoCount[team]+=1;if(!isNaN(parseInt(range[j][12]))){cpoF_I[team]+=parseInt(range[j][12]);}}
